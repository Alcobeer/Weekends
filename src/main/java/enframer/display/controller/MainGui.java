...
public class MainGui {
    ...
    private void initialize() {
        ...
        Tooltip checkBoxTp = new Tooltip("В случае, если галочка поставлена, то рамка будет расширена таким образом, чтобы изображение могло полностью в неё поместиться.");
